...
public class MenuUtils {
  ...
  public static List<DrawerMenu> createDrawerMenu() {
    ...
    menuList.add(new DrawerMenu(R.drawable.ic_action_view_list, R.string.menu_index));
    ...
    menuList.add(new DrawerMenu(R.drawable.ic_action_settings, R.string.menu_settings));
